...
//	public ResponseEntity<Product> createProduct(@RequestBody Product product, Category category, UriComponentsBuilder ucBuilder) {
//		
//		Category categoryAux = categoryService.findCategoryByName(category.getCategoryName());
//		
//		if(categoryAux != null) {
